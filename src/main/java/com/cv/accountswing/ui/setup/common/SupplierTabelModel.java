...
public class SupplierTabelModel extends AbstractTableModel {
    ...
    private List<Supplier> listCustomer = new ArrayList();
    ...
    public Object getValueAt(int row, int column) {
        ...
        try {
            Supplier customer = listCustomer.get(row);
    ...
    public List<Supplier> getListCustomer() {
        return listCustomer;
    }

    public void setListCustomer(List<Supplier> listCustomer) {
