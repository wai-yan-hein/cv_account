...
import com.cv.accountswing.ui.cash.common.RemarkTableModel;
...
public class RefAutoCompleter implements KeyListener {
    ...
    private RemarkTableModel remarkModel;
    ...
    public RefAutoCompleter(AutoTextService autoTextService) {
        this.autoTextService = autoTextService;
        if (Global.listRef == null) {
            Global.listRef = autoTextService.search("REF");
        }
    }
    ...
    public RefAutoCompleter(JTextComponent comp, List<AutoText> list,
            AbstractCellEditor editor) {
        this.textComp = comp;
        this.editor = editor;
        textComp.putClientProperty(AUTOCOMPLETER, this);
        textComp.setFont(Global.textFont);
        remarkModel = new RemarkTableModel(Global.listRef);
        table.setModel(remarkModel);
        table.setSize(25, 25);
    ...
    public void mouseSelect() {
        if (table.getSelectedRow() != -1) {
            autoText = remarkModel.getRemark(table.convertRowIndexToModel(
                    table.getSelectedRow()));
            ((JTextField) textComp).setText(autoText.getDesp());
            if (editor == null) {
            }
        }
    ...
    public void setAutoText(AutoText autoText) {
        ...
        textComp.setText(autoText.getDesp());
