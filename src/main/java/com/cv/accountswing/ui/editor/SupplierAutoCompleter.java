...
import com.cv.accountswing.ui.cash.common.SupplierTableModel;
 ...
 * @author Lenovo
 */
public class SupplierAutoCompleter implements KeyListener {

    private static final org.slf4j.Logger log = LoggerFactory.getLogger(SupplierAutoCompleter.class);
    private JTable table = new JTable();
    private JPopupMenu popup = new JPopupMenu();
    private JTextComponent textComp;
    private static final String AUTOCOMPLETER = "AUTOCOMPLETER"; //NOI18N
    private SupplierTableModel traderTableModel;
    private Supplier trader;
    ...
    public SupplierAutoCompleter() {
    }

    public SupplierAutoCompleter(JTextComponent comp, List<Supplier> list,
            AbstractCellEditor editor) {
        this.textComp = comp;
        this.editor = editor;
        textComp.putClientProperty(AUTOCOMPLETER, this);
        textComp.setFont(Global.textFont);
        traderTableModel = new SupplierTableModel(list);
    ...
    Action showAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            SupplierAutoCompleter completer = (SupplierAutoCompleter) tf.getClientProperty(AUTOCOMPLETER);
            if (tf.isEnabled()) {
    ...
    public Supplier getTrader() {
        return trader;
    }

    public void setTrader(Supplier trader) {
        this.trader = trader;
        if (trader != null) {
