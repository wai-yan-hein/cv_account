...
public class StockAutoCompleter implements KeyListener {
    ...
    public StockAutoCompleter(JTextComponent comp, List<Stock> list,
        ...
        stockTableModel = new StockTableModel(list);
        stockTableModel.modifyColumn();
        ...
        if (table.getSelectedRow() != -1) {
            ...
            if (editor == null) {
                if (selectionObserver != null) {
                    selectionObserver.selected("Stock", stock.getStockCode());
                }
            }
        }
    ...
    private Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            stock = stockTableModel.getDepatment(completer.table.convertRowIndexToModel(
