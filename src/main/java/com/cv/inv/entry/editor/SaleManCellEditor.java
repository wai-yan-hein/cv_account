 ...
 * @author Lenovo
 */
public class SaleManCellEditor extends AbstractCellEditor implements TableCellEditor {

    private static final Logger LOGGER = LoggerFactory.getLogger(SaleManCellEditor.class);
    private JComponent component = null;
    private SaleManAutoCompleter completer;
    ...
    public java.awt.Component getTableCellEditorComponent(JTable table, Object value,
        ...
        completer = new SaleManAutoCompleter(jtf, Global.listSaleMan, this);
        return component;
    }
    ...
    public Object getCellEditorValue() {
        Object obj;
        SaleMan type = completer.getSaleMan();
